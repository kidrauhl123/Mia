...
function verifyRelease() {
  const requiredFiles = [
    ...
    "api/src/cloud-agent/group-routing.js",
    ...
    "api/skills/_builtin/officecli/SKILL.md",
    "api/skills/_builtin/officecli/LICENSE",
    "api/skills/_builtin/officecli/UPSTREAM_NOTICE",
    "api/skills/_builtin/officecli/THIRD_PARTY_NOTICES.md",
    "api/skills/_builtin/officecli-docx/SKILL.md",
    "api/skills/_builtin/officecli-xlsx/SKILL.md",
    "api/skills/_builtin/officecli-pptx/SKILL.md",
    "api/skills/_builtin/officecli-sources.json",
    "web/index.html",
    ...
    "web/shared/agent-engine-policy.js",
  ...
  childProcess.execFileSync(process.execPath, ["-e", `
    ...
    require(${JSON.stringify(assertFile("api/src/cloud/group-host.js"))});
    ...
    require(${JSON.stringify(assertFile("api/src/cloud-agent/group-routing.js"))});
...
function main() {
  ...
  copyFile("src/shared/agent-engine-policy.js", path.join(webDir, "shared", "agent-engine-policy.js"));
