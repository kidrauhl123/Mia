...
RELEASE_ARTIFACT_KEEP_QUOTED="$(shell_quote "$RELEASE_ARTIFACT_KEEP")"
...
RELEASE_ARTIFACT_KEEP=$RELEASE_ARTIFACT_KEEP_QUOTED
...
sync_web_release
run_as_root node "$REMOTE_RELEASE_DIR/prune-release-artifacts.js" \
  --apply \
