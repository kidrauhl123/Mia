...
```text
Research a brand for desktop pet mascot creation.
...
```bash
SKILL_DIR="/absolute/path/to/skills/pet-generator"
...
```text
Generate the pet-generator base image.
...
```text
Generate one pet-generator row.
...
```text
Visually QA one finalized pet-generator contact sheet.
