...
contextBridge.exposeInMainWorld("mia", {
  ...
  onboardingComplete: (input = {}) => ipcRenderer.invoke(IpcChannel.OnboardingComplete, input),
  ...
  social: {
    ...
    listImChannels: () => ipcRenderer.invoke(IpcChannel.SocialListImChannels),
    createImChannel: (body) => ipcRenderer.invoke(IpcChannel.SocialCreateImChannel, body),
