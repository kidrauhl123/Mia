(function attachIpcChannels(root, factory) {
  ...
  const IpcChannel = Object.freeze({
    ...
    DesktopNotificationClick: "desktop-notification:click",
	    ...
	    MiaCoreRuntimeSnapshotInvalidate: "mia-core:runtime-snapshot-invalidate",
    ...
    SocialListImChannels: "social:list-im-channels",
    SocialCreateImChannel: "social:create-im-channel",
    ...
    SocialGetCloudWechatClawbotStatus: "social:get-cloud-wechat-clawbot-status",
    SocialStartCloudWechatClawbotLink: "social:start-cloud-wechat-clawbot-link",
    SocialSubmitCloudWechatClawbotPairingCode: "social:submit-cloud-wechat-clawbot-pairing-code",
    SocialDisconnectCloudWechatClawbot: "social:disconnect-cloud-wechat-clawbot",
