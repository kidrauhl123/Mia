...
function pluginFiles() {
  return {
    ...
    "scheduler_mcp.py": [
      ...
      "        'description': 'Create and activate a Mia scheduled task. Use this for reminders, alarms, countdowns, and recurring tasks. The created task appears in Mia active tasks and fires back into the same conversation.',",
      "        'inputSchema': {",
      "            'type': 'object',",
      "            'properties': {",
      "                'title': {'type': 'string'},",
