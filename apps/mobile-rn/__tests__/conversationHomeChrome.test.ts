...
test("消息首页使用紧凑 chrome", () => {
  ...
  expect(conversationHomeChrome.row.minHeight).toBe(70);
  expect(conversationHomeChrome.row.minHeightWithTags).toBe(73);
  ...
  expect(conversationHomeChrome.title.fontSize).toBe(20);
